...
#define GOODIX_CORE_DRIVER_NAME "goodix_ts_atb"
#define GOODIX_PEN_DRIVER_NAME "goodix_ts_atb,pen"
...
struct goodix_ts_core {
	int init_stage;
	struct cdev tool_cdev;
	dev_t tool_devno;
	char tool_dev_name[GOODIX_MAX_STR_LABLE_LEN];
